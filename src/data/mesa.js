...
export const TRACKS = [
    ...
    { id: 'hat', label: 'Hi-hat', corto: 'HAT', voz: 'metal', opts: { decay: 0.055, hp: 7800, choke: 'hat' } },
    { id: 'diana', label: 'Diana', corto: 'DNA', voz: 'diana', opts: {}, acento: true },
    { id: 'palmas', label: 'Palmas', corto: 'PLM', voz: 'palmas', opts: {} },
    { id: 'hatab', label: 'Hat abierto', corto: 'H-A', voz: 'metal', opts: { decay: 0.34, hp: 6600, nivelBase: 0.3, choke: 'hat' } },
    { id: 'tom', label: 'Tom', corto: 'TOM', voz: 'tom', opts: { pitch: 150 } },
    { id: 'sub', label: '808', corto: '808', voz: 'sub', opts: { decay: 0.8 }, usaTonica: true, acento: true },
];
...
export const PAD_TECLAS = ['1', '2', '3', '4', 'q', 'w', 'e', 'r', 'a', 's', 'd', 'f', 'z', 'x', 'c', 'v'];
...
const NOMBRES_NOTA = ['Do', 'Do♯', 'Re', 'Mi♭', 'Mi', 'Fa', 'Fa♯', 'Sol', 'Sol♯', 'La', 'Si♭', 'Si'];
...
const BANCO_KIT = [
    ...
    { id: 'bombo-largo', label: 'Bombo largo', voz: 'bombo', opts: { pitch: 44, decay: 0.75, drive: 0.45 }, track: 'bombo', tipo: 'grave' },
    ...
    { id: 'hat', label: 'Hat', voz: 'metal', opts: { decay: 0.055, hp: 7800, choke: 'hat' }, track: 'hat', tipo: 'agudo' },
    { id: 'hatab', label: 'Hat abierto', voz: 'metal', opts: { decay: 0.34, hp: 6600, nivelBase: 0.3, choke: 'hat' }, track: 'hatab', tipo: 'agudo' },
    { id: 'shaker', label: 'Shaker', voz: 'shaker', opts: {}, tipo: 'agudo' },
    { id: 'tom-grave', label: 'Tom grave', voz: 'tom', opts: { pitch: 108, decay: 0.42 }, track: 'tom', tipo: 'medio' },
    { id: 'tom-agudo', label: 'Tom agudo', voz: 'tom', opts: { pitch: 215 }, track: 'tom', tipo: 'medio' },
    { id: 'diana', label: 'Diana', voz: 'diana', opts: {}, track: 'diana', tipo: 'agudo' },
    { id: 'crash', label: 'Crash', voz: 'metal', opts: { decay: 1.5, hp: 3800, color: 6000, base: 58, nivelBase: 0.22, send: 0.3 }, tipo: 'agudo' },
    { id: 'sub', label: '808', voz: 'sub', opts: { decay: 1 }, track: 'sub', tonica: -24, tipo: 'grave' },
    { id: 'sub-slide', label: '808 caída', voz: 'caida', opts: {}, tonica: -24, tipo: 'grave' },
    { id: 'redoble-caja', label: 'Redoble', voz: 'caja', opts: {}, redoble: { veces: 8, pulsos: 1 }, tipo: 'medio' },
    { id: 'redoble-hat', label: 'Hat roll', voz: 'metal', opts: { decay: 0.05, hp: 7800 }, redoble: { veces: 12, pulsos: 1 }, tipo: 'agudo' },
];

const BANCO_FX = [
    { id: 'riser', label: 'Riser', voz: 'barrido', opts: { dur: 1.6 }, tipo: 'aire' },
    { id: 'bajada', label: 'Bajada', voz: 'barrido', opts: { desde: 7200, hasta: 320, dur: 0.9 }, tipo: 'aire' },
    ...
    { id: 'zap', label: 'Zap', voz: 'laser', opts: { desde: 2600, hasta: 420, dur: 0.16, tipo: 'square' }, tipo: 'agudo' },
    ...
    { id: 'acorde-M', label: 'Acorde M', voz: 'acorde', opts: { grados: [0, 4, 7] }, tonica: -12, tipo: 'aire' },
    { id: 'sub-largo', label: 'Sub largo', voz: 'sub', opts: { decay: 1.6 }, tonica: -24, tipo: 'grave' },
    { id: 'subidon', label: 'Subidón', voz: 'reversa', opts: { dur: 1.9 }, tipo: 'aire' },
    { id: 'cinta', label: 'Freno cinta', voz: 'laser', opts: { desde: 700, hasta: 60, dur: 0.7, tipo: 'triangle' }, tipo: 'grave' },
];
...
export function padsDelBanco(bancoId, raizMidi) {
    ...
    return lista.map((pad) =>
        pad.tonica === undefined
            ? pad
            : { ...pad, opts: { ...pad.opts, midi: raizMidi + pad.tonica } }
    );
}
