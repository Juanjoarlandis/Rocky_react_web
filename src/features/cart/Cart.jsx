...
import PlaceholderTee from '../catalog/PlaceholderTee';
      ...
      <div className="doodle-shelf cart-list-wrap">
        ...
        <ul className="paper-card cart-list">
          {cart.map((product) => {
            ...
            const lineTotal =
              formatPrice(product.lineCost?.totalAmount) ||
              (localPrice !== null ? formatPrice(localPrice * product.quantity) : null);
          ...
          <div className="cart-summary-row">
            ...
            <span className="cart-summary-total">
              {isShopify
                ...
                : hasUnknownPrices
                  ? knownSubtotal > 0
                    ? `${formatPrice(knownSubtotal)} + pendiente`
                    : 'Pendiente'
