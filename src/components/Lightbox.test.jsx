...
describe('Lightbox', () => {
  ...
  it('devuelve el foco al elemento que la abrió al desmontarse, sin disparar close', () => {
    const { close } = stubDialog();
    const onClose = vi.fn();
    const opener = document.createElement('button');
    document.body.appendChild(opener);
    opener.focus();
    const { unmount } = render(<Lightbox src="/foto.webp" alt="Camiseta" onClose={onClose} />);
