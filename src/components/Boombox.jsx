    ...
    return (
        ...
        >
            ...
            <path
                ...
                strokeLinecap="round"
            />
            <rect x="202" y="78" width="20" height="14" rx="4" fill="var(--card)" stroke="var(--ink)" strokeWidth="4" />
            <rect x="416" y="78" width="20" height="14" rx="4" fill="var(--card)" stroke="var(--ink)" strokeWidth="4" />
            ...
            <g className="bb-senal">
                <path d="M632 28 Q640 20 634 8" fill="none" stroke="var(--accent)" strokeWidth="3.5" strokeLinecap="round" />
                <path d="M610 22 Q606 14 612 6" fill="none" stroke="var(--accent)" strokeWidth="3.5" strokeLinecap="round" />
            </g>
            ...
            <g className="bb-mando">
                ...
                <path d="M124 122 L133 115" stroke="var(--accent)" strokeWidth="3.5" strokeLinecap="round" />
            </g>
            ...
            <rect x="496" y="114" width="26" height="14" rx="7" fill="var(--card)" stroke="var(--ink)" strokeWidth="3.5" />
            <circle cx="516" cy="121" r="4" fill="var(--ink)" />
            <circle className="bb-luz" cx="552" cy="121" r="7" fill="var(--card)" stroke="var(--ink)" strokeWidth="3.5" />
            ...
            <g className="bb-diana">
                ...
                <path d="M128 150 L128 174 M128 250 L128 274 M66 212 L90 212 M166 212 L190 212" stroke="var(--accent)" strokeWidth="5" strokeLinecap="round" />
                <circle cx="128" cy="212" r="5" fill="var(--ink)" />
            </g>
            <path d="M158 258 L166 250 M166 262 L174 254" stroke="var(--ink)" strokeWidth="3" strokeLinecap="round" />
            {/* Altavoz derecho */}
            <g className="bb-diana">
                ...
                <path d="M512 150 L512 174 M512 250 L512 274 M450 212 L474 212 M550 212 L574 212" stroke="var(--accent)" strokeWidth="5" strokeLinecap="round" />
                <circle cx="512" cy="212" r="5" fill="var(--ink)" />
            </g>
            <path d="M542 258 L550 250 M550 262 L558 254" stroke="var(--ink)" strokeWidth="3" strokeLinecap="round" />
            {/* Placa de la marca, encima de la boca del casete */}
            <rect x="246" y="142" width="148" height="27" rx="7" fill="var(--ink)" />
            <text x="320" y="162" textAnchor="middle" fontFamily="'Luckiest Guy', cursive" fontSize="17" fill="var(--card)">
                ROCKY SOUND
            </text>
            {/* Boca del casete en el aparato */}
            <rect x="224" y="178" width="192" height="96" rx="10" fill="var(--paper)" stroke="var(--ink)" strokeWidth="5.5" />
            {/* La cinta metida dentro: concha con sus cuatro tornillos */}
            <rect x="238" y="188" width="164" height="72" rx="7" fill="var(--card)" stroke="var(--ink)" strokeWidth="4" />
            <path
            ...
            <rect x="252" y="194" width="136" height="24" rx="4" fill="var(--card)" stroke="var(--ink)" strokeWidth="2.5" />
            ...
            <rect x="272" y="220" width="96" height="28" rx="14" fill="var(--paper)" stroke="var(--ink)" strokeWidth="3.5" />
            ...
            <path d="M303 260 L308 251 L332 251 L337 260" fill="none" stroke="var(--ink)" strokeWidth="3" strokeLinejoin="round" />
