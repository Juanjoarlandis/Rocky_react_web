...
export function BeeDoodle(props) {
    return (
        <svg viewBox="0 0 200 120" xmlns="http://www.w3.org/2000/svg" role="img" aria-hidden="true" {...props}>
            ...
            />
            {/* Alas */}
            <ellipse cx="152" cy="38" rx="13" ry="19" transform="rotate(-24 152 38)" fill="var(--card)" stroke="var(--ink)" strokeWidth="3.5" />
            <ellipse cx="170" cy="36" rx="11" ry="16" transform="rotate(18 170 36)" fill="var(--card)" stroke="var(--ink)" strokeWidth="3.5" />
            {/* Cuerpo a rayas miel */}
            <ellipse cx="158" cy="70" rx="30" ry="21" fill="currentColor" stroke="var(--ink)" strokeWidth="4.5" />
            <path d="M148 51 L144 89 M162 50 L160 91 M176 55 L174 86" stroke="var(--ink)" strokeWidth="4.5" strokeLinecap="round" />
            ...
            <path d="M121.5 65 L134.5 65 M128 58.5 L128 71.5" stroke="var(--accent)" strokeWidth="1.6" strokeLinecap="round" />
            {/* Antenas */}
            <path d="M124 54 Q120 46 113 44 M135 53 Q135 44 141 40" fill="none" stroke="var(--ink)" strokeWidth="3" strokeLinecap="round" />
