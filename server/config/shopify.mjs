import { readList, readLooseBoolean } from './env.mjs';
import { createStorageConfig } from './storage.mjs';
...
export function createShopifyConfig(env, appConfig, storageConfig = createStorageConfig(env)) {
  ...
  const hasStateStore = storageConfig.hasStateStore;
  ...
  return {
    ...
    exposeQuantity: readLooseBoolean(env.SHOPIFY_EXPOSE_QUANTITY),
    clientId,
    clientSecret,
    customerClientId,
